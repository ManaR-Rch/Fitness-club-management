...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $reservation = new Reservation(null, $_SESSION['user_id'], htmlspecialchars($_POST['activity']), htmlspecialchars($_POST['date']), 'confirmee');
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="ms-1 text-sm text-dark">Fitness</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-dark" href="./myreservations.php">
            <i class="material-symbols-rounded opacity-5">book</i>
            <span class="nav-link-text ms-1">Reservations</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-white" href="./book.php">
            <i class="material-symbols-rounded opacity-5">create</i>
            <span class="nav-link-text ms-1">Book activity</span>
          </a>
        </li>
      </ul>
    </div>
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-dark w-100" href="./../auth/logout.php" type="button">Logout</a>
      </div>
    </div>
  </aside>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Book an activity</li>
          </ol>
        </nav>
      </div>
    </nav>
          ...
          <div class="card">
            ...
            <div class="card-body px-0 pb-2 px-4">
              <form action="" method="post">
                <input type="hidden" name="id_membre" value="<?php echo $_SESSION['user_id'] ?>">
